function walkCut(argument0, argument1, argument2, argument3) {
	...
	with argument0{
	    if x-argument1>0 and !place_meeting(x-32,y,oSolid){
	        if mtl<0{
	            mtl=(x-argument1)/argument3
				ms=1
			}
	    }
	    else if x-argument1<0 and !place_meeting(x+32,y,oSolid){
	        if mtr<0{
