...
uni_time = shader_get_uniform(shd_sepia,"time");
var_time_var = 0;

uni_mouse_pos = shader_get_uniform(shd_sepia,"mouse_pos");
var_mouse_pos_x = mouse_x - __view_get( e__VW.XView, 0 );
var_mouse_pos_y = mouse_y - __view_get( e__VW.YView, 0 );

uni_resolution = shader_get_uniform(shd_sepia,"resolution");
var_resolution_x = __view_get( e__VW.WView, 0 );
var_resolution_y = __view_get( e__VW.HView, 0 );

uni_strength = shader_get_uniform(shd_sepia,"strength");
var_uni_strength = 0.80;
